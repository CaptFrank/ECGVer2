...
public final class ChartRESP
    ...
    public void run() {
            ...
            ChartOXI showcase = new ChartOXI();
            showcase.init();
  ...
  final class ControlPanel
    ...
    private void createAmountPointSlider() {
      ...
      int maxPoints = ChartRESP.this.getTrace().getMaxSize();
      ...
      this.m_amountPointsSlider.addChangeListener(new ChangeListener() {
        public void stateChanged(final ChangeEvent e) {
          ...
          if (!source.getValueIsAdjusting()) {
            ...
            ChartRESP.this.getTrace().setMaxSize(value);
          }
        }
      });
    ...
    private void createColorChooserButton() {
      ...
      this.m_colorChooser.addActionListener(new ActionListener() {
        public void actionPerformed(final ActionEvent ae) {
          ...
          ChartRESP.this.getTrace().setColor(color);
        }
      });
    ...
    private void createLatencySlider() {
      ...
      this.m_latencyTimeSlider.setValue((int) ChartRESP.this.getCollector().getLatency());
      ...
      this.m_latencyTimeSlider.addChangeListener(new ChangeListener() {
        public void stateChanged(final ChangeEvent e) {
          ...
          if (!source.getValueIsAdjusting()) {
            int value = source.getValue();
            ChartRESP.this.getCollector().setLatency(value);
          }
        }
      });
    }
    ...
    private void createSnapShotButton() {
      ...
      this.m_snapshot = new JButton(Chart2DActionSaveImageSingleton.getInstance(
          ChartRESP.this.m_chart, "Save image"));
    ...
    private void createStartStopButton() {
      ...
      this.m_startStop.addActionListener(new ActionListener() {
        public void actionPerformed(final ActionEvent e) {
          ...
          if (ChartRESP.this.getCollector().isRunning()) {
            ChartRESP.this.stopData();
            source.setText("start");
            running = false;
          } else {
            ChartRESP.this.startData();
            source.setText("stop");
            running = true;
          }
          source.invalidate();
  ...
  public void init() {
    ...
    chart.getAxisY().setRange(new Range(-10, 10));
    chart.setGridColor(Color.LIGHT_GRAY);
    this.setTrace(new Trace2DLtd(100));
    this.getTrace().setName("RESP Value");
    this.getTrace().setPhysicalUnits("Milliseconds", "Oxi value");
    ...
    this.setCollector(new DataAcquisitionOXI(this.getTrace(), 100));
   ...
   */
  private void setCollector(final DataAcquisitionOXI collector) {
