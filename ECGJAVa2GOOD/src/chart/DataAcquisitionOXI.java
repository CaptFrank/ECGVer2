...
public class DataAcquisitionOXI extends ADataCollector{
   ...
   */
  public DataAcquisitionOXI(final ITrace2D trace, final int latency) {
    super(trace, latency);
  }
  ...
  public TracePoint2D collectData() {
    ...
    this.m_y = ecgjava2.SplitParse.getPotnum();
