 ...
 *
 */
public final class ChartAmbTemp
    ...
    public void run() {
            ...
            ChartAmbTemp showcase = new ChartAmbTemp();
            showcase.init();
  ...
  final class ControlPanel
    ...
    private void createAmountPointSlider() {
      ...
      int maxPoints = ChartAmbTemp.this.getTrace().getMaxSize();
      ...
      this.m_amountPointsSlider.addChangeListener(new ChangeListener() {
        public void stateChanged(final ChangeEvent e) {
          ...
          if (!source.getValueIsAdjusting()) {
            ...
            ChartAmbTemp.this.getTrace().setMaxSize(value);
          }
        }
      });
    ...
    private void createColorChooserButton() {
      ...
      this.m_colorChooser.addActionListener(new ActionListener() {
        public void actionPerformed(final ActionEvent ae) {
          ...
          ChartAmbTemp.this.getTrace().setColor(color);
        }
      });
    ...
    private void createLatencySlider() {
      ...
      this.m_latencyTimeSlider.setValue((int) ChartAmbTemp.this.getCollector().getLatency());
      ...
      this.m_latencyTimeSlider.addChangeListener(new ChangeListener() {
        public void stateChanged(final ChangeEvent e) {
          ...
          if (!source.getValueIsAdjusting()) {
            int value = source.getValue();
            ChartAmbTemp.this.getCollector().setLatency(value);
          }
        }
      });
    }
    ...
    private void createSnapShotButton() {
      ...
      this.m_snapshot = new JButton(Chart2DActionSaveImageSingleton.getInstance(
          ChartAmbTemp.this.m_chart, "Save image"));
    ...
    private void createStartStopButton() {
      ...
      this.m_startStop.addActionListener(new ActionListener() {
        public void actionPerformed(final ActionEvent e) {
          ...
          if (ChartAmbTemp.this.getCollector().isRunning()) {
            ChartAmbTemp.this.stopData();
            source.setText("start");
            running = false;
          } else {
            ChartAmbTemp.this.startData();
            source.setText("stop");
            running = true;
          }
          source.invalidate();
  ...
  public void init() {
    ...
    this.getTrace().setName("Ambient Temperature");
    this.getTrace().setPhysicalUnits("Milliseconds", "Temp. value");
    ...
    this.setCollector(new DataAcquisitionAmbTemp(this.getTrace(), 100));
   ...
   */
  private void setCollector(final DataAcquisitionAmbTemp collector) {
