 ...
 *
 */
public final class ChartBreathPer
    extends JApplet implements Runnable{
    static public boolean stop = false;

    public void run() {
            JFrame frame = new JFrame("Temp Data Chart");
            frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            ChartBreathPer showcase = new ChartBreathPer();
            showcase.init();
  ...
  final class ControlPanel
    ...
    private void createAmountPointSlider() {
      ...
      int maxPoints = ChartBreathPer.this.getTrace().getMaxSize();
      ...
      this.m_amountPointsSlider.addChangeListener(new ChangeListener() {
        public void stateChanged(final ChangeEvent e) {
          ...
          if (!source.getValueIsAdjusting()) {
            ...
            ChartBreathPer.this.getTrace().setMaxSize(value);
          }
        }
      });
    ...
    private void createClearButton() {
      ...
      this.m_clear.addActionListener(new ActionListener() {
        public void actionPerformed(final ActionEvent e) {
          ChartBreathPer.this.clearTrace();
        }
      });
    ...
    private void createColorChooserButton() {
      ...
      this.m_colorChooser.addActionListener(new ActionListener() {
        public void actionPerformed(final ActionEvent ae) {
          ...
          ChartBreathPer.this.getTrace().setColor(color);
        }
      });
    ...
    private void createLatencySlider() {
      ...
      this.m_latencyTimeSlider.setValue((int) ChartBreathPer.this.getCollector().getLatency());
      ...
      this.m_latencyTimeSlider.addChangeListener(new ChangeListener() {
        public void stateChanged(final ChangeEvent e) {
          ...
          if (!source.getValueIsAdjusting()) {
            int value = source.getValue();
            ChartBreathPer.this.getCollector().setLatency(value);
          }
        }
      });
    }
    ...
    private void createSnapShotButton() {
      ...
      this.m_snapshot = new JButton(Chart2DActionSaveImageSingleton.getInstance(
          ChartBreathPer.this.m_chart, "Save image"));
    ...
    private void createStartStopButton() {
      ...
      this.m_startStop.addActionListener(new ActionListener() {
        public void actionPerformed(final ActionEvent e) {
          ...
          if (ChartBreathPer.this.getCollector().isRunning()) {
            ChartBreathPer.this.stopData();
            source.setText("start");
            running = false;
          } else {
            ChartBreathPer.this.startData();
            source.setText("stop");
            running = true;
          }
          source.invalidate();
  ...
  public static void main(final String[] args) {
    ChartBreathPer Chart = new ChartBreathPer();
    Chart.run();
  }
  ...
  public void init() {
    ...
    this.getTrace().setName("Alcohol %");
    this.getTrace().setPhysicalUnits("Milliseconds", "Alcohol Value");
    ...
    this.setCollector(new DataAcquisitionTemp(this.getTrace(), 100));
   ...
   */
  private void setCollector(final DataAcquisitionTemp collector) {
