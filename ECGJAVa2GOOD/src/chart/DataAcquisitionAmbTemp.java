...
public class DataAcquisitionAmbTemp extends ADataCollector{
   ...
   */
  public DataAcquisitionAmbTemp(final ITrace2D trace, final int latency) {
    super(trace, latency);
  }
  ...
  public TracePoint2D collectData() {
    ...
    this.m_y = ecgjava2.SplitParse.getDiffTemp();
