...
public class DataAcquisitionBreathvalue extends ADataCollector{
   ...
   */
  public DataAcquisitionBreathvalue(final ITrace2D trace, final int latency) {
    super(trace, latency);
  }
  ...
  public TracePoint2D collectData() {
    ...
    this.m_y = ecgjava2.SplitParseBreath.getValueNum();
