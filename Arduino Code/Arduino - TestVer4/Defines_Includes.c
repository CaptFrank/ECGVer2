...
#define VitalsHeader            "Time, ECG, RED, IR, ERROR, RESP\n"
#define OthersHeader            "Time, Light, Battery\n"
...
// in this one:
// time, ECG, SPO2 RAW, SPO2 IR, SPO2 ERROR, RESP (11 characters -> in 220 we get 20 samples/page)

char vdipBuffer2[220];
PString logEntryVitals(vdipBuffer2, sizeof(vdipBuffer2)); // Create a PString object called logEntry

// in this one:
// time, Light, Battery (5 characters -> in 100 we get 20 samples/page)

char vdipBuffer3[100];
